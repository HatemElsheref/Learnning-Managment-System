            ...
            <div class="container margin_80">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-6 pl-lg-5 order-lg-last">
                        <img alt="" src="{{route('storage',['universities_avatars',$university->photo,null,null])}}" class="img-fluid rounded">
                    </div>
                    <div class="col-lg-6 pt-4 order-lg-first">
                        ...
                        <strong class="d-block"> <span class="icon-ok text-success"></span> {{$university->address}}</strong>
                        <strong class="d-block" > <span class="icon-ok text-success"></span> {{count($university->departments)}} Departments</strong>
        ...
        <div class="container margin_60_35">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="{{route('university.department',$department->slug)}}" class="grid_item">


                        <figure style="height: 200px;">
                            <img  class="img-responsive img-fluid"  src="{{route('storage',['departments_avatars',$department->photo])}}" alt="{{$department->name}}">
                            <div class="info">

                                <em><i class="icon-play-circled"></i>    <small>{{count($department->courses)}} courses</small></em>
            ...
            <!-- /row -->
            @if(count($university->departments) ==0)
                <h5>No Departments Founded ..</h5>
            @endif
        </div>
        <!--/container-->
                        ...
                        <div class="item">
                            <article class="blog" >
                                ...
                                <div class="post_info">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="thumb"><img src="{{route('storage',['instructors_avatars',$item->instructor->photo])}}" alt=""></div>
