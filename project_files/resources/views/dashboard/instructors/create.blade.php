                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0 breadcrumb-inverse">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Add New Instructor</li>
                        </ol>
                    </nav>
                </div>
                <div>
                ...
                <div class="col-12">
                    <div class="card card-default">
                        <div class="card-body">
                            ...
                            <form action="{{route('instructor.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" value="{{old('title')}}" placeholder="Enter Instructor Title">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone" value="{{old('phone')}}" placeholder="Enter Instructor Phone">
                                </div>
