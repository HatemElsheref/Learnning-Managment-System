...
<head>
    <head>
        ...
        <title>@lang('dashboard.login_page')</title>
        ...
        <div class="col-xl-5 col-lg-6 col-md-10" >
            <div class="card">
                ...
                <div class="card-body p-5">
                    ...
                    <h4 class="text-dark mb-3" style="{{CurrentLanguage()=='ar'?'text-align:end;':''}}">@lang('dashboard.login_btn')</h4>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex my-2 justify-content-between">
                                    <div class="d-inline-block mr-3">
                                        <label class="control control-checkbox">@lang('dashboard.remember_me')
                                            <input type="checkbox" name="remember"  {{ old('remember') ? 'checked' : '' }}/>
                                            <div class="control-indicator"></div>
                                        </label>

                                    </div>
                                    <p><a class="text-blue" href="{{route('ShowForgetPasswordForm')}}">@lang('dashboard.forget_password_question')</a></p>
                                </div>
                                <button type="submit" class="btn btn-lg btn-primary btn-block mb-4">@lang('dashboard.login_btn')</button>
