                ...
                <div class="col-12">
                    <div class="card card-default">
                        <div class="card-body">
                            ...
                            <form action="{{route('feedback.update',$feedback->id)}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                @method('put')
                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input type="text" class="form-control" id="name" name="name" value="{{$feedback->name}}" placeholder="Enter  Name">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control"  name="country_id" >
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{$country->id}}" @if($feedback->country_id==$country->id) selected @endif>
                                                {{$country->Name}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="universities" name="university_id" >
                                        ...
                                        @foreach($universities as $university)
                                            <option value="{{$university->id}}" @if($university->id==$feedback->department->university->id) selected @endif>
                                                {{$university->name}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="departments" name="department_id"  >
                                                  <option  value="{{$feedback->department->id}}" selected>{{$feedback->department->name}}</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <ul class="list-unstyled list-inline">
                                        <li class="d-inline-block">
                                            <label class="control control-radio">Image
                                                <input type="radio" value="image" name="type" @if($feedback->type=='image') checked @endif>
                                                <div class="control-indicator"></div>
                                            </label>
                                        </li>
{{--                                        <li class="d-inline-block mr-3 ">--}}
{{--                                            <label class="control control-radio">Audio--}}
{{--                                                <input type="radio"  value="audio" name="type"  @if($feedback->type=='audio') checked @endif>--}}
{{--                                                <div class="control-indicator"></div>--}}
{{--                                            </label>--}}
{{--                                        </li>--}}
                                        <li class="d-inline-block mr-3">
                                            <label class="control control-radio">Video
                                                <input type="radio" value="video" name="type" @if($feedback->type=='video' or $feedback->type=='audio') checked @endif>
                                                <div class="control-indicator"></div>
                                            </label>
                                        </li>
                                    </ul>
