                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0 breadcrumb-inverse">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Add New Department</li>
                        </ol>
                    </nav>
                </div>
                <div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('department.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{old('name')}}" placeholder="Enter  Department Name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="slug" name="slug" value="{{old('slug')}}" placeholder="Enter Department Slug">
                                </div>
