                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-0 breadcrumb-inverse">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Add New Tag</li>
                        </ol>
                    </nav>
                </div>
                <div>
                ...
                <div class="col-12">
                    <div class="card card-default">
                        <div class="card-body">
                            ...
                            <form action="{{route('tag.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                <div class="form-group">
                                    <label for="name">Tag Name</label>
                                    <input type="text" class="form-control" id="name" name="name" value="{{old('name')}}" placeholder="Enter Tag Name">
                                </div>
