                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('post.update',$post->id)}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="description" name="description" value="{{$post->description}}" placeholder="Enter Post Description">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-1 col-lg-1">
                                        <img id="tmp_image" class="img-circle" onclick="document.getElementById('photo').click();" style="width:50px;height: 50px;" src="{{route('UPLOADED.FILES',['posts_photos',$post->photo,null,null])}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="form-group" >
                                        <select class=" form-control " name="instructor_id" id="instructor">
                                            ...
                                            @foreach($instructors as $instructor)
                                                <option value="{{$instructor->id}}" @if($post->instructor_id==$instructor->id) selected @endif>{{$instructor->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group" >
                                        <select class=" js-example-basic-multiple form-control " name="tags[]" multiple id="tags">
                                            @foreach($tags as $tag)
                                                <option value="{{$tag->id}}" @if(in_array($tag->id,(array)$post->tags->pluck('id')->toArray())) selected @endif>{{$tag->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea id="editor1" name="content">{!! $post->content !!}</textarea>
                                </div>
                                <div class="form-group">
                                    <h1>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{$post->meta_title}}" placeholder="Enter Post Meta Title">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="meta_description" name="meta_description" value="{{$post->meta_description}}" placeholder="Enter Post Meta Description">
                                </div>
                                    ...
                                    <ul class="list-unstyled list-inline">
                                        <li class="d-inline-block mr-3">
                                            <label class="control control-checkbox">Published
                                                <input type="checkbox" name="status" value="published" @if($post->status) checked @endif>
